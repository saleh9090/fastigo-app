...
<head>
  ...
  <!-- icofont-css-link -->
  <link rel="stylesheet" href="/landing/css/icofont.min.css">
...
<body>
  ...
  <div class="page_wrapper">
      ...
      <div class="container">
        ...
        <nav class="navbar navbar-expand-lg">
          <a class="navbar-brand" href="#">
            <img src="/landing/images/logo.png" alt="image" >
          </a>
              ...
              <li class="nav-item has_dropdown">
                ...
                <div class="sub_menu">
                  <ul>
                    ...
                    <li><a href="#">Another submenu 2</a></li>
                    <li><a href="#">Submenu 3</a></li>
                    <li><a href="#">Another submenu 4</a></li>
                  </ul>
                </div>
              </li>
              <!-- secondery menu end -->
    ...
    <section class="banner_section">
      <!-- hero bg -->
      <div class="hero_bg"> <img src="/landing/images/hero-bg.png" alt="image" > </div>
      <!-- container start -->
      <div class="container">
        <!-- row start -->
        <div class="row">
          ...
          <div class="trial_box_list">
              <ul>
                <li><i class="icofont-check-circled"></i> Free trial 14 days</li>
                <li><i class="icofont-check-circled"></i> No credit card require</li>
              </ul>
          </div>
            ...
            <div class="used_app">
              <ul>
                <li><img src="/landing/images/used01.png" alt="image" ></li>
                <li><img src="/landing/images/used02.png" alt="image" ></li>
                <li><img src="/landing/images/used03.png" alt="image" ></li>
                <li><img src="/landing/images/used04.png" alt="image" ></li>
              </ul>
          ...
          <div class="col-lg-3 col-md-6"  data-aos="fade-in" data-aos-duration="1500">
            <div class="banner_images image_box1">
                <span class="banner_image1"> <img class="moving_position_animatin" src="/landing/images/bannerimage1.png" alt="image" > </span>
                <span class="banner_image2"> <img class="moving_animation" src="/landing/images/bannerimage2.png" alt="image" > </span>
            </div>
          </div>

          <div class="col-lg-3 col-md-6"  data-aos="fade-in" data-aos-duration="1500">
            <div class="banner_images image_box2">
                <span class="banner_image3"> <img class="moving_animation" src="/landing/images/bannerimage3.png" alt="image" > </span>
                <span class="banner_image4"> <img class="moving_position_animatin" src="/landing/images/bannerimage4.png" alt="image" > </span>
            </div>
          </div>
          <!-- banner slides end -->
    ...
    <section class="row_am features_section" id="features">
      <!-- section bg -->
      <div class="feature_section_bg"> <img src="/landing/images/section-bg.png" alt="image" > </div>
      <!-- container start -->
      <div class="container">
        <div class="features_inner">
          ...
          <div class="feature_img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
            <img src="/landing/images/device-feature.png" alt="image" >
          </div>
          ...
          <div class="features_block">
            ...
            <div class="col-md-3">
                <div class="feature_box" data-aos="fade-up" data-aos-duration="1500">
                    <div class="image">
                      <img src="/landing/images/secure_data.png" alt="image" >
                    </div>
                    <div class="text">
                      <h4>Secure data</h4>
            ...
            <div class="col-md-3">
                <div class="feature_box" data-aos="fade-up" data-aos-duration="1700">
                    <div class="image">
                      <img src="/landing/images/functional.png" alt="image" >
                    </div>
                    <div class="text">
            ...
            <div class="col-md-3">
                <div class="feature_box" data-aos="fade-up" data-aos-duration="1900">
                    <div class="image">
                      <img src="/landing/images/live-chat.png" alt="image" >
                    </div>
                    <div class="text">
                      <h4>Secure data</h4>
                      <p>Lorem Ipsum is simply dummy text of the printing and type setting indus ideas.</p>
            ...
            <div class="col-md-3">
                <div class="feature_box" data-aos="fade-up" data-aos-duration="1900">
                    <div class="image">
                      <img src="/landing/images/support.png" alt="image" >
                    </div>
                    <div class="text">
                      <h4>Secure data</h4>
                      <p>Simply dummy text of the printing and typesetting indus lorem Ipsum is dummy.</p>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="about_img" data-aos="fade-in" data-aos-duration="1500">
              <div class="frame_img">
                <img class="moving_position_animatin" src="/landing/images/about-frame.png" alt="image" >
              </div>
              <div class="screen_img">
                <img class="moving_animation" src="/landing/images/about-screen.png" alt="image" >
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            ...
            <div class="about_text">
              ...
              <ul class="app_statstic" id="counter" data-aos="fade-in" data-aos-duration="1500">
                <li>
                  <div class="icon">
                    <img src="/landing/images/download.png" alt="image" >
                  </div>
                  <div class="text">
                ...
                <li>
                  <div class="icon">
                    <img src="/landing/images/followers.png" alt="image" >
                  </div>
                  <div class="text">
                ...
                <li>
                  <div class="icon">
                    <img src="/landing/images/reviews.png" alt="image" >
                  </div>
                  <div class="text">
                ...
                <li>
                  <div class="icon">
                    <img src="/landing/images/countries.png" alt="image" >
                  </div>
                  <div class="text">
    ...
    <section class="row_am modern_ui_section">
      <!-- section bg -->
      <div class="modernui_section_bg"> <img src="/landing/images/section-bg.png" alt="image" > </div>
      <!-- container start -->
      <div class="container">
      	<!-- row start -->
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="/landing/images/modern01.png" alt="image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
                <img class="moving_position_animatin" src="/landing/images/shield_icon.png" alt="image" >
                <img class="moving_position_animatin" src="/landing/images/modern02.png" alt="image" >
                <img class="moving_position_animatin" src="/landing/images/modern03.png" alt="image" >
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="row_am how_it_works" id="how_it_work">
      <!-- section bg -->
      <div class="how_section_bg"> <img src="/landing/images/section-bg.png" alt="image" > </div>
      <!-- container start -->
      <div class="container">
            ...
            <ul>
              ...
              <li>
                ...
                <div class="step_img" data-aos="fade-left" data-aos-duration="1500">
                  <img src="/landing/images/download_app.jpg" alt="image" >
                </div>
              </li>
              ...
              <li>
                ...
                <div class="step_img" data-aos="fade-right" data-aos-duration="1500">
                  <img src="/landing/images/create_account.jpg" alt="image" >
                </div>
              </li>
              ...
              <li>
                ...
                <div class="step_img" data-aos="fade-left" data-aos-duration="1500">
                  <img src="/landing/images/enjoy_app.jpg" alt="image" >
                </div>
              </li>
            </ul>
          </div>
        ...
        <div class="yt_video" data-aos="fade-in" data-aos-duration="1500">
          <div class="thumbnil">
            <img src="/landing/images/yt_thumb.png" alt="image" >
            <a class="popup-youtube play-button" data-url="https://www.youtube.com/embed/tgbNymZ7vqY?autoplay=1&mute=1" data-toggle="modal" data-target="#myModal" title="XJj2PbenIsU">
              <span class="play_btn">
                <img src="/landing/images/play_icon.png" alt="image" >
      ...
      <div class="container">
        ...
        <div class="testimonial_block" data-aos="fade-in" data-aos-duration="1500">
          <div id="testimonial_slider" class="owl-carousel owl-theme">
            ...
            <div class="item">
              <div class="testimonial_slide_box">
                ...
                <div class="testimonial_img">
                  <img src="/landing/images/testimonial_user1.png" alt="image" >
                </div>
                <h3>Shayna John</h3>
            ...
            <div class="item">
              <div class="testimonial_slide_box">
                ...
                <div class="testimonial_img">
                  <img src="/landing/images/testimonial_user2.png" alt="image" >
                </div>
                <h3>Willium Den</h3>
                <span class="designation">Careative inc</span>
              </div>
            ...
            <div class="item">
              <div class="testimonial_slide_box">
                ...
                <div class="testimonial_img">
                  <img src="/landing/images/testimonial_user3.png" alt="image" >
                </div>
                <h3>Cyrus Stephen</h3>
                <span class="designation">Careative inc</span>
              </div>
          ...
          <div class="avtar_faces">
            <img src="/landing/images/avtar_testimonial.png" alt="image" >
          </div>
        </div>
      </div>
      <!-- container end -->
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="pricing_block">
                <div class="icon">
                  <img src="/landing/images/standard.png" alt="image" >
                </div>
                <div class="pkg_name">
                  <h3>Standard</h3>
            ...
            <div class="col-md-4">
              <div class="pricing_block highlited_block">
                <div class="icon">
                  <img src="/landing/images/unlimited.png" alt="image" >
                </div>
                <div class="pkg_name">
                  <h3>Unlimited</h3>
            ...
            <div class="col-md-4">
              <div class="pricing_block">
                <div class="icon">
                  <img src="/landing/images/premium.png" alt="image" >
                </div>
                <div class="pkg_name">
                  <h3>Premium</h3>
    ...
    <section class="row_am faq_section">
      <!-- section bg -->
      <div class="faq_bg"> <img src="/landing/images/section-bg.png" alt="image" > </div>
      <!-- container start -->
      <div class="container">
        <div class="section_title" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
          <!-- h2 -->
            ...
            <div id="screen_slider" class="owl-carousel owl-theme">
              <div class="item">
                <div class="screen_frame_img">
                    <img src="/landing/images/screen-1.png" alt="image" >
                </div>
              </div>
              <div class="item">
                <div class="screen_frame_img">
                    <img src="/landing/images/screen-2.png" alt="image" >
                </div>
              </div>
              <div class="item">
                <div class="screen_frame_img">
                    <img src="/landing/images/screen-3.png" alt="image" >
                </div>
              </div>
              <div class="item">
                <div class="screen_frame_img">
                    <img src="/landing/images/screen-4.png" alt="image" >
                </div>
              </div>
              <div class="item">
                <div class="screen_frame_img">
                    <img src="/landing/images/screen-5.png" alt="image" >
                </div>
              </div>
              <div class="item">
                <div class="screen_frame_img">
        ...
        <div class="container">
            <div class="free_app_inner" data-aos="fade-in" data-aos-duration="1500" data-aos-delay="100"> 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="free_text">
                            ...
                            <ul class="app_btn">
                              <li>
                                <a href="#">
                                  <img src="/landing/images/appstore_blue.png" alt="image" >
                                </a>
                              </li>
                              <li>
                                <a href="#">
                                  <img src="/landing/images/googleplay_blue.png" alt="image" >
                                </a>
                              </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="free_img">
                            <img src="/landing/images/download-screen01.png" alt="image" >
                            <img class="mobile_mockup" src="/landing/images/download-screen02.png" alt="image" >
                        </div>
                    </div>
                </div>
                <!-- row end -->
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                <div class="story_box" data-aos="fade-up" data-aos-duration="1500">
                    <div class="story_img">
                      <img src="/landing/images/story01.png" alt="image" >
            ...
            <div class="col-md-4">
                <div class="story_box" data-aos="fade-up" data-aos-duration="1500">
                    <div class="story_img">
                      <img src="/landing/images/story02.png" alt="image" >
                      <span>45 min ago</span>
                    </div>
                    <div class="story_text">
            ...
            <div class="col-md-4">
                <div class="story_box" data-aos="fade-up" data-aos-duration="1500">
                    <div class="story_img">
                      <img src="/landing/images/story03.png" alt="image" >
                      <span>45 min ago</span>
                    </div>
                    <div class="story_text">
      ...
      <div class="container">
        ...
        <div class="company_logos" >
          <div id="company_slider" class="owl-carousel owl-theme">
            <div class="item">
              <div class="logo">
                <img src="/landing/images/paypal.png" alt="image" >
              </div>
            </div>
            <div class="item">
              <div class="logo">
                <img src="/landing/images/spoty.png" alt="image" >
              </div>
            </div>
            <div class="item">
              <div class="logo">
                <img src="/landing/images/shopboat.png" alt="image" >
              </div>
            </div>
            <div class="item">
              <div class="logo">
                <img src="/landing/images/slack.png" alt="image" >
              </div>
            </div>
            <div class="item">
              <div class="logo">
                <img src="/landing/images/envato.png" alt="image" >
              </div>
            </div>
            <div class="item">
              <div class="logo">
    ...
    <footer>
        <!-- section bg -->
        <div class="footer_bg"> <img src="/landing/images/section-bg.png" alt="image" > </div>
            ...
            <div class="container">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6 col-12">
                      <div class="abt_side">
                        <div class="logo"> <img src="/landing/images/footer_logo.png" alt="image" ></div>
                        <ul>
        ...
        <!-- go top button -->
        <div class="go_top">
            <span><img src="/landing/images/go_top.png" alt="image" ></span>
        </div>
    </footer>
    <!-- Footer-Section end -->
